...
<%
    ...
    if (isSearchApply != null) {
        orderby = "asc";
        if ("high".equalsIgnoreCase(pricefilter)) {
            orderby = "desc";
        }
        ...
        if (pricefilter == null) {
            ...
            if (pricefilter.equalsIgnoreCase("low")) {
                orderby = "asc";
                products = generfunc.getProductPricefilterList(orderby);
            } else if (pricefilter.equalsIgnoreCase("high")) {
                orderby = "desc";
                products = generfunc.getProductPricefilterList(orderby);
            } else if (pricefilter.equalsIgnoreCase("sortNumbers")) {
                orderby = "desc";
                products = generfunc.getProductListNumSorted(orderby);
            }
        }
    }
...
%>
<%--<body onload="VlidateRequestloadMoreAjax();">--%>
                                                ...
                                                <form action="searchNumbers" method="post">
                                                    ...
                                                    <div class="col-sm-6" style="padding: 1px; display: none">
                                                        <input name="search" type="text" placeholder="Search Number"
                                                               value="248" style="height:50px; display: none">
                                                    </div>
            ...
            <div class="col-md-9 col-sm-12">
                ...
                <div class="row">
                    <nav class="sortingOptions button-group mini clearfix" style="margin-bottom:20px;">
                        ...
                        <a href="VIPNumbers?pricefilter=sortNumbers" class="btn btn-default">Serial Wise 9-0</a>
                    </nav>
                </div>
