...
<div id="site-container" class="site-fullscreen site-sticky">
    ...
    <aside class="blog-search" style="margin-bottom:0px;">
        	...
        	<section id="services" class="box-yellow">
		<div class="wrapper padding-top-bottom padding-top-bottom2 overflowhi">
       <div class="text-center">
        <h2 class="headingpage" style="line-height:25px; color:#fff;">Launches  <br>
<span style="font-size:25px; color:#fff;">NEW NUMBERS</span>
        </h2>
        </div>
        ...
        <div class="col-sm-12">
            	...
            	<%
            	             ...
            	             <%} %>
                                ...
                                <a href="productDetails?id=<%=product.getProduct_id()%>" class="buttonleft">   <div class="booknow">View details</div> </a>
...
<span style="font-size:25px;">VIP NUMBERS</span>
        ...
        <%
        	...
        	<div class="numberbox">
                ...
                <p> Sum total: <%=product.getLiters() %>=<b><%=product.getTrap() %> </b></p><b>
            
            <a href="CartActivity?vProductId=<%= product.getProduct_id()%>&vProductName=<%= product.getNumber()%>&vImgLoc=<%= product.getImg_loc()%>&action=<%= GeneralConstants.ADD_TO_CART %>">	<div class="booknow"> BUY NOW</div> </a>
                
             <a class="buttonleft" href="productDetails?id=<%=product.getProduct_id()%>">   <div class="booknow">View details</div> </a>
         ...
         <div class="text-center">
         <div class="col-sm-12">
        	<a href="VIPNumbers" class="btn btn-default wi100 gradiyant margin-top-10 "><i class="fa fa-pencil-square-o"></i> MORE NUMBER</a>
            </div>
			</div>
						...
						<div class="grid-list grid-vertical with-icons">
							<div class="row margin-none">
								...
								<div class="grid col-md-12 col-sm-12 wow fadeInRight" data-wow-duration="4s">
									...
									<p class="line-bottom">Once your chosen mobile number is finalised, proceed to checkout and make the payment.
</p>
								</div>
								<!-- Grid Col End-->
        ...
        <h2 class="headingpage" style="color:#FFF">Testimonial</h2>
					...
					<div class="testimonials-horizontal" id="owl-testimonials">
						<div class="item">
							...
							<div class="item-comment">"I find this site very good value for money.Highly recommended.You will get N Number of option and even the prices are Good"</div>
						...
						<div class="item">
							...
							<div class="item-comment">"Very good service, I appreciate and recommend to trust this organisation, I am from Baghpat, UP recently buy good mobile number, worth for money.."</div>
						...
						<div class="item">
							...
							<div class="item-comment">"Amazing variety of numbers to choose from. Prices are also very reasonable! Worth the money"</div>
						...
						<div class="item">
							...
							<div class="item-comment">"There is a variety of numbers to choose from. Good experience overall including staff and everything else. Would recommend for sure!!"</div>
