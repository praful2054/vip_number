...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        function validationResendi()
        {
            let mobileNo = document.getElementById('telephone').value;
            let name = document.getElementById('cust_name').value;
            let email = document.getElementById('email').value;
            if (mobileNo == ""){
                alert('Please Enter Mobile No.');
            }
            else if(name == ""){ alert('Please Enter Customer Name.')}
            else if(email == ""){ alert('Please Enter email address.')}
            else{
                // alert("OTP Resend Sucessfully");
                VlidateOTPRequestAjax(mobileNo, name, email);
            }
        }

        function VlidateOTPRequestAjax(vParentCategoryId, vParentCategoryName, vParentCategoryemail){
            ...
            req.send("vParentCategoryId=" + encodeURIComponent(vParentCategoryId) +
                "&vParentCategoryName=" + encodeURIComponent(vParentCategoryName) +
                "&vParentCategoryemail=" + encodeURIComponent(vParentCategoryemail));
        }
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-sm-12">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#menu1">Login / Registration</a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="menu1" class="tab-pane data-form fade in active">
                            ...
                            <%
                                ...
                                CustomerAddressDetails billingAddressDetails = null;
                                CustomerAddressDetails shippingAddressDetails = null;
                                if (loginId.contains("@")) {
                                ...
                                if (customerDetails != null) {
                                    isCustomer = true;
                                    customerLoginDetail = (CustomerLoginDetail) customerDetails.get("custLoginDetails");
                                    billingAddressDetails = (CustomerAddressDetails) customerDetails.get("custBillingDetails");
                                    shippingAddressDetails = (CustomerAddressDetails) customerDetails.get("custShippingDetails");
                                    //System.out.println("id "+customerLoginDetail.getCust_id());


                                    try {
                                        int otp = 10000 + new Random().nextInt(90000);
                                        String Message = "Dear " + billingAddressDetails.getFirstName() + ", " + otp + " is OTP to access your VipNumberStore.in account. OTP is valid for 5 min. Do not share your OTP with anyone.";
                                        //String Message = "Dear "+billingAddressDetails.getFirstName()+", Thank you For Registration. "+otp+" is The OTP For Request. Regards Vipnumberstore.in";
                                        String sendUrl = "https://alerts.kaleyra.com/api/v4/?method=sms&api_key=A95f6ac715c8eb5e4eac8a88b231a4d8a&to=" + billingAddressDetails.getContactNo1().trim() + "&sender=VIPNUM&message=" + Message + "";
                                        ...
                                        prepare.setString(1, billingAddressDetails.getContactNo1());
                            ...
                            <form action="validateOtpLogin.jsp" method="post">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 margin-bottom-10">
                                        <img src="assets/img/otp_verify.jpg" class="img-responsive preLoad loaded"
                                             alt="" title="" style="width: 18%;margin-top: -30px;margin-bottom: 10px;">
                                        <h2 class="heading_for_subtitle" style="font-size: 25px">Verify with OTP</h2>
                                        <!-- <label>E-Mail</label> -->
                                        <div class="form-field">
                                            <i class="fa fa-envelope-o"></i>
                                            <input type="text" name="otp" placeholder="Enter OTP" required="">
                                            <a class="resendContainer" style="
                                                margin-top: 20px;
                                                font-size: 12px;
                                                font-weight: 650;
                                                color: #f23800;
                                                cursor: pointer;
                                                " onclick="validationResendi()">RESEND OTP
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <input type="hidden" name="custName" id="cust_name" value="<%=shippingAddressDetails.getFirstName()%>"></input>
                                ...
                                <input type="hidden" name="telephone" id="telephone" value="<%=request.getParameter("email")%>">
                            </form>
                            <%} else { %>
                            <form action="registerCustomerOTPcheck.jsp" method="post">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="number" name="telephone" placeholder="Enter your Mobile No"
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="midLinks"
                                             style="margin-top: 10px;margin-left: 1%;font-size: 10px;margin-bottom: 20px;">
                                            By continuing, I agree to the <a href="/terms_and_condition.html"
                                                                             style="color: blue;">Terms of Use</a> &amp;
                                            <a href="/privacy-policy.html"
                                               style="color: blue;">Privacy Policy</a></div>
                                        <input type="submit" class="btn btn-default" value="Continue" style="">
                                    </div>
                                </div>
