							...
							<div class="row">
                           	 ...
                           	 try{
                           		...
                           		PreparedStatement prepare = null;
                           		 ...
                           		 prepare1=con.prepareStatement("select firstName,contactNo1 from CustomerBillingDetails where cust_id in(select cust_id from CustomerLoginDetails where emailid='"+loginId+"')");
                           		...
                           		if(rs.next()){
                           			...
                           			String textmessage="Dear "+firstName+", "+otp+" is your VIP NUMBER STORE Account Password reset code. Don't share this with anyone. Regards VIP NUMBER STORE";		
                           	       // String textmessage="Dear "+firstName+", "+otp+" is your VIP NUMBER STORE Account Password reset code. Don't share this with anyone. Regards VIP NUMBER STORE";
                           			...
                           			sbPostData.append("&to="+contactNo1);
                           			...
                           			prepare.setString(1,contactNo1);
                           			...
                           			Email.mailsend(loginId, sub, textmessage, "");
                           		}
                           	 }catch(Exception e){
                           		 e.printStackTrace();
                           	 }
                                ...
                                %>
								      ...
								      <p>An OTP will be sent via SMS to your mobile number.</p>
								      <div class="form-field margin-bottom-10">
										<i class="fa fa-key"></i>
										<input type="text" name="otp" placeholder="Enter your OTP Number" required class="margin-bottom-10">
                                 
                                    </div>
                                    
									<div class="form-field margin-bottom-10">
										<i class="fa fa-key"></i>
										<input type="password" name="password" placeholder="New Password" required class="margin-bottom-10">
                                 
                                    </div>
                                    
                                    <div class="form-field">
										<i class="fa fa-key"></i>
										<input type="password" name="password" placeholder="Confirm Password" required class="margin-bottom-10">
                                   
                                    </div>
								
								<input type="hidden" name="loginId" value="<%=loginId%>"/>
							<input type="hidden" name="mobileNo" value="<%=contactNo1%>"/>
                             <%}else{ %> 
                                  <p>Invalid Email Address. <a href="forgotpassword.html">Click Here</a> to Retry</p>
                             <%} %>
								</div>
							</div>
