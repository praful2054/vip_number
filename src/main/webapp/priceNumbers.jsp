...
<%
String vanityCheck = request.getParameter("param1");
String vanityCheck2 = request.getParameter("param2");

if ((vanityCheck!= null && vanityCheck.matches("[0-9]+")) && (vanityCheck2!= null && vanityCheck2.matches("[0-9]+"))) {
	
	int priceLow = Integer.parseInt(request.getParameter("param1"));
	int priceHigh = Integer.parseInt(request.getParameter("param2"));
               ...
               session.setAttribute("currency","INR");
				...
				List<CustomProduct> products = null;
					...
					String orderby="";
					if(pricefilter==null){
						products = generfunc.getProductListSearchPriceFilter(String.valueOf(priceLow),String.valueOf(priceHigh));
						...
						products = generfunc.getProductListSearchPriceFilter(String.valueOf(priceLow),String.valueOf(priceHigh),orderby);
					}
				%>
<body>
...
<div id="site-container" class="site-fullscreen site-sticky">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body blog-search"><form name="form" action="searchNumbers" method="post">
									...
									<ul>
										<%
											for(Category category : parentCategory) {
				       					  %> 
										<li><a href="CategoryNumbers?cateID=<%=category.getCate_id()%>&Name=<%=category.getCate_name() %>&parentCateId=<%=category.getCate_id() %>" class="btn btn-default"><%=category.getCate_name() %></a></li>
										<%} %>
									</ul>
								</nav></div>
    </div>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse3" class="panel-collapse collapse">
      ...
      <nav>
									<ul>
										<li><a href="priceNumbers?param1=0&param2=1500" class="btn btn-default">0-1500 </a></li>
										<li><a href="priceNumbers?param1=1501&param2=3000" class="btn btn-default">1501-3000</a></li>
										<li><a href="priceNumbers?param1=3001&param2=5000" class="btn btn-default">3001-5000</a></li>
										<li><a href="priceNumbers?param1=5001&param2=10000" class="btn btn-default">5001 - 10000 </a></li>
										<li><a href="priceNumbers?param1=10001&param2=30000" class="btn btn-default">10001 - 30000 </a></li>
										<li><a href="priceNumbers?param1=30001&param2=50000" class="btn btn-default">30001 - 50000 </a></li>
										<li><a href="priceNumbers?param1=50001&param2=100000" class="btn btn-default">50001 - 100000 </a></li>
                                        <li><a href="priceNumbers?param1=100001&param2=1000000" class="btn btn-default">100001 -1000000 </a></li>
									</ul>
								</nav>
    ...
    right: 12px;"><i class="fa fa-search"></i> Search</button>
								</form>
							</aside>
        ...
        <nav class="button-group mini clearfix" style="margin-bottom:20px;">
						...
						<a href="priceNumbers?param1=<%=priceLow%>&param2=<%=priceHigh%>&pricefilter=low" class="btn btn-default">Price Low to High</a>
						<a href="priceNumbers?param1=<%=priceLow%>&param2=<%=priceHigh%>&pricefilter=high" class="btn btn-default">Price High to Low</a>
...
<%}else{
	System.out.println("Error in Price Numbers  :- "+new Date()+" >>>  "+vanityCheck);
	    String remoteAddr = "";
	    if (request != null) {
