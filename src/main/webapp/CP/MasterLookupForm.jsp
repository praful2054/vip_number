...
<nav class="navbar navbar-static-top">
  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
                                <form class="form-horizontal" action="insertMaster"  method="post" name="form">
									...
									<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="country">
													...
													%>
														<option value="<%=country.getLookupCode() %>"><%=country.getLookupMeaning() %></option>
													<%} %>
                                                </select>
                                            </div>
                                        </div>
									...
									%>
									   <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="type" type="text" value="" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="shippingCharge" type="text" value="" >
                                            </div>
                                        </div>
                                        <%} %>
							         	
										 <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Add Master Details</button>
                                        </div>
                                     </form>
