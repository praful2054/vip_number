...
<body class="hold-transition skin-red fixed sidebar-mini" onload="hideshow();">
<div class="wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
	                   <%
						...
						%>
                       <form class="form-horizontal" action="InsertProductDetail"  method="post" name="form">
                                    
                                    <div class="form-group">
                                            <label class="col-sm-2 control-label">Category</label>
                                            <div class="col-sm-10">
                                                <select style="width:250px" name="sub_cate_id" required>
                                                    <option value="">---Select-----</option>
                                                    <%
                                                    for(Category category : parentCategoryList){
															%>
																<option value="<%= category.getCate_id() %>"><%=category.getCate_name() %></option>
															<%
														}
													%>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="veg"  required>
                                                <option value="">---Select-----</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <textarea  name="prodName" rows="10" cols="80" required="required"></textarea>
                                            </div>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="rateRuppes" type="text" value="" required="required">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="vendorId"  required>
                                         		...
                                         		ResultSet res1 = stmt1.executeQuery("select * from vendorDetails where status='Y'");
                                                 while(res1.next()) {
                                                 %>
                                                 <option value="<%=res1.getString("id") %>"><%=res1.getString("firstname") %></option>
                                                <%}DBConnection.close(con, stmt1, res1); %>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="rateBlack" type="text" value="0" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="discount" type="text" value="0">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="fdiscount" type="text" value="0">
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Add Number Details</button>
                                        </div>
