              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <%
                                	    ...
                                	    if(startDate !=null && endDate!=null && !startDate.equals("null") && !endDate.equals("null")){
                                			res = stmt.executeQuery("select * from vendorPaymentDetails where vendorId='"+VendorId+"' and DATE(paymentDate) between '"+startDate+"' and '"+endDate+"'");
                                		}else{
                                			res = stmt.executeQuery("select * from vendorPaymentDetails where vendorId='"+VendorId+"'");
                                		}
                                        ...
                                        <tr>
                                           ...
                                           <td class="center">&nbsp;</td>
                                           <%} %>
                                            <td class="center"><%=res.getString("remarks") %></td>
                                            <td class="center"><a class="glyphicon glyphicon-trash" href="delete?id=<%= res.getString("id") %>&type=vendorpayment&vendorId=<%=VendorId%>"></a></td>
                                            </tr>
                                        <%
                                            }
