  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
                       ...
                       <form class="form-horizontal" action="requirementFollowupComment"  method="post" name="form">
                                     <%
                                        String eid = request.getParameter("id");
                                        String status="", requirement ="",budget="",buyerName="",BuyerContact="",BuyerRate="", empId="";
                                        DBConnection dbcon = new DBConnection();
                                		Connection con = dbcon.getCon();
                                		Statement stmt =  con.createStatement();
                                		Statement stmt1 =  con.createStatement();
                                	
                                		 ResultSet rs = stmt1.executeQuery("select * from requirements where id="+eid);
                                		 if(rs.next()) {
                                			 requirement = rs.getString("requirements");
                                			 budget= rs.getString("budget");
                                			 buyerName= rs.getString("Buyer_Name");
                                			 BuyerContact= rs.getString("Buyer_Contact");
                                			 BuyerRate= rs.getString("Buyer_Rate");
                                		...
                                		if(profile.equalsIgnoreCase("Admin") || profile.equalsIgnoreCase("Lead") || profile.equalsIgnoreCase("SEO") || profile.equalsIgnoreCase("Support")){
                                        ...
                                        <%
                                        if(profile.equalsIgnoreCase("Admin") || profile.equalsIgnoreCase("Lead") ){
                                        %>
                                        <tr>
                                         ...
                                         <td class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="buyerName" type="text" value="<%=buyerName %>" >
                                            </div>
                                        </td>
                                        ...
                                        <td class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="buyerContact" type="text" value="<%=BuyerContact %>" >
                                            </div>
                                        </td>
                                        </tr>
                                        <tr>
                                         <td class="form-group">
                                            <label class="col-sm-4 control-label">Buyer Rate</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="buyerRate" type="text" value="<%=BuyerRate%>" >
                                            </div>
                                        </td>
                                        </tr>
                                        <%}else{ %>
                                        <input type="hidden" name="buyerName" value="<%=buyerName %>">
                                         <input type="hidden" name="buyerContact" value="<%=BuyerContact %>">
                                          <input type="hidden" name="buyerRate" value="<%=BuyerRate %>">
                                        <%} %>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
							                ...
							                <tbody>
							                <%
							                ResultSet rees = stmt.executeQuery("select e.*,emp.firstname,emp.lastname  from requirementsfollowup e, employee emp where enq_id="+eid+" and emp.loginId = e.commenyBy order by UpdatedDate desc ");
	                                        while(rees.next()) {
