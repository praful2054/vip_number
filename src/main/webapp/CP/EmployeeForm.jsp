  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
                       ...
                       <form class="form-horizontal" action="insertEmployee"  method="post" name="form">
                       
                                     <div class="form-group">
                                            <label class="col-sm-2 control-label">Login Id</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="loginId" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="lastname" type="text" value="" required="required">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-2 control-label">Contact Number</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="contactno1" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Email Address</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="contactno2" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Add Employee Details</button>
                                        </div>
