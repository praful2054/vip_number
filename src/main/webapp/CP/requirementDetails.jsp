              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss");
                                        ...
                                        <td class="center"><%=sr %></td>
                                            <td class="center"><%=res.getString("requirements") %></td>
                                            <td class="center"><%=res.getString("budget") %></td>
											<td class="center"><%=res.getString("status") %></td>
											<td class="center"><%=res.getString("Created_Date")%></td>
											 <td class="center"><%=Full_Name %></td>
													
                                            <td class="center">
                                                    <a class="glyphicon glyphicon-edit" href="requirementFollowup?id=<%= res.getString("id")%>"></a>&nbsp;&nbsp;
											</td>
