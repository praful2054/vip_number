  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 ...
	 try{
	   ...
	   if (multi!=null){	
			prepare=con.prepareStatement("update vendorDetails set password=?,firstname=?,address=?,address2=?,contactno1=?,Website=?,paytmNo=?,gpayNo=?,isRegistered=?,docs=?,nickName=?,bankName=?,accountName=?,accountNumber=?,branchLocation=?,ifscCode=?, updatedDate=Now() where id=?");
			...
			prepare.setString(9,multi.getParameter("isregister"));
			prepare.setString(10,multi.getFilesystemName("cate_img_upload"));
			prepare.setString(11,multi.getParameter("nickName"));
			prepare.setString(12,multi.getParameter("bankName"));
			prepare.setString(13,multi.getParameter("accountName"));
			prepare.setString(14,multi.getParameter("accountNumber"));
			prepare.setString(15,multi.getParameter("branchLocation"));
			prepare.setString(16,multi.getParameter("ifscCode"));
			prepare.setString(17,multi.getParameter("id"));
	 ...
	 %>
		 <div class="callout callout-success">
                <h4>Vendor Update Sucessfully !</h4>
              </div>
		 <%}
