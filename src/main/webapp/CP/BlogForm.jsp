...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
                                <form class="form-horizontal" action="insertblog"  method="post" name="form" ENCTYPE="multipart/form-data">
                                  
                                         <div class="form-group">
                                            <label class="col-sm-2 control-label">Blog Title</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="blogName" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="col-sm-10">
                                                <textarea id="editor1" name="blogDescript" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                    	...
                                    	<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="uType">
                                          ...
                                          <div class="form-group">
                                            <label class="col-sm-2 control-label">Upload Image Only</label>
                                            <div class="col-sm-6">
                                         ...
                                         <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Add BLOG Details</button>
                                        </div>
