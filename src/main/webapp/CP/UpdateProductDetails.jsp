	 ...
	 try{
		 ...
		 PreparedStatement prepare = null, prepare1=null;
			Connection con=new DBConnection().getCon();
				...
				prepare=con.prepareStatement("insert into auditProductDetails (select * from ProductDetails where product_id='"+request.getParameter("hdnProductId")+"')");
				int i = prepare.executeUpdate();
				
				prepare1=con.prepareStatement("insert into auditProductOtherDetails (select * from ProductOtherDetails where product_id="+request.getParameter("hdnProductId")+")");
				int j = prepare1.executeUpdate();
		 ...
		 ClassPathXmlApplicationContext context = (ClassPathXmlApplicationContext) application.getAttribute("context");
			...
			product.setVendor_id(Integer.parseInt(request.getParameter("vendorId")));
			product.setStatus("Y");
			...
			productOtherDetail.setFlatdiscountedrate(Integer.parseInt(request.getParameter("fdiscount")));
