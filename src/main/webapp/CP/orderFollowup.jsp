			 ...
			 <div class="content-wrapper">
						...
						<div class="box box-success">
						 ...
						 <div class="box-body">
                            ...
                            <form class="form-horizontal" action="orderFollowupComment"  method="post" name="form" >
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="status">
                                                    <option value="Order Confirmed" <%if(status.equalsIgnoreCase("Order Confirmed")){%>selected<%} %>>Order Confirmed</option>
													...
													<option value="Order Placed" <%if(status.equalsIgnoreCase("Order Placed")){%>selected<%} %>>Order Placed</option>
													...
													<option value="Test" <%if(status.equalsIgnoreCase("Test")){%>selected<%} %>>Test</option>
													<option value="Cancelled" <%if(status.equalsIgnoreCase("Cancelled")){%>selected<%} %>>Cancelled</option>
													<option value="Refund" <%if(status.equalsIgnoreCase("Refund")){%>selected<%} %>>Refund</option>
                                                </select>
                                            </div>
                                        </div>
										...
										<input type="hidden" name="assignTo" id="assignTo" value="<%=empId %>">
                                    	<input type="hidden" name="enq_id" id="enq_id" value="<%=eid %>">
