	...
	<div class="box box-success">
	 ...
	 try{
		 ...
		 con=new DBConnection().getCon();
			...
			prepare=con.prepareStatement("insert into requirements values(0, ?, ?, ?, ?, ?, ?, ?, ?, Now(),?,Now())");
			prepare.setString(1,request.getParameter("requirements"));
			prepare.setString(2,request.getParameter("budget"));
			prepare.setString(3,"");
			prepare.setString(4,"");
			prepare.setString(5,"");
			prepare.setString(6,"New");
			prepare.setString(7,eid);
			prepare.setString(8,eid);
			prepare.setString(9,"");
