	 ...
	 try{
		   ...
		   if (multi!=null){	
	    	   ...
	    	   AbstractQueryParameter obj = new CategoryQueryParameter(category);
	            obj.setSql(QueryConstants.CATEGORY_INSERT_QUERY);
	            obj.setAction(GeneralConstants.INSERT);
	            Number id = dbAction.executeDMLToGetId(obj);
	            
	            if(id != null && multi.getParameter("parentCategoryId") != null) {
	            	//Adding into cache map
	            	Map<String, String> map = (Map<String,String>) application.getAttribute("categoriesMap");
	            	String key = multi.getParameter("parentCategoryId");
	            	if(map.containsKey(key)) {
	            		String value = map.get(key);
	            		value = value + "," + id.intValue();
	            		map.put(key, value);
	            	} else {
	            		String value = String.valueOf(id.intValue());								            		
	            		map.put(key, value);
	            	}
	            	 while(true) {
	                     key = generfunc.getParentCategoryId(key);
	                     ...
	                     if(map.containsKey(key)) {
	                         ...
	                         map.put(key, String.valueOf(id.intValue()));
	                     }
	                 }
	            }
	 %>
