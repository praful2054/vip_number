                ...
                <%
                                        ...
                                        <td class="center"><%=res.getString("id") %></td>
                                           <td class="center"><%=res.getString("loginId") %></td>
                                            ...
                                            <td class="center"><%=res.getString("profile") %></td>
                                            <td class="center"><%=res.getString("firstname") %> <%=res.getString("lastname") %></td>
                                            <td class="center"><%=res.getString("contactno1") %></td>
											<td class="center"><%=res.getString("contactno2") %></td>
											
											 <td class="center">
													<%
														if(res.getString("status").equalsIgnoreCase("Y")){
															%>
																<a href="activate?id=<%= res.getString("id")%>&activate=N&type=employee">Deactivate</a>
															<%	
														}
														else{
															%>
																<a href="activate?id=<%= res.getString("id")%>&activate=Y&type=employee">Activate</a>
															<%
														}
													%>  
													
                                            <td class="center">
                                                    <a class="glyphicon glyphicon-edit" href="employeeEditForm?id=<%= res.getString("id")%>"></a>&nbsp;&nbsp;
													<a class="glyphicon glyphicon-trash" href="delete?id=<%=res.getString("id") %>&type=employee"></a>
												</td>
