            ...
            <div class="box-body">
              <table id="example1" class="table table-striped table-hover dt-responsive" width="100%">
                                    ...
                                    <tbody>
                                		...
                                		ResultSet res = stmt.executeQuery("select * from BlogComment where blogId ="+request.getParameter("id"));
                                        while(res.next()) {
										%>
                                        <tr>
                                            <td class="center"><%=res.getString("id") %></td>
                                            <td class="center"><%=res.getString("bloggerName") %></td>
                                            <td class="center"><%=res.getString("emailId") %></td>
                                            <td class="center"><%=res.getString("comment") %></td>
                                            <td class="center">
												<a class="glyphicon glyphicon-trash" href="delete?id=<%=res.getString("id") %>&type=blogcomment"></a>
											</td>
