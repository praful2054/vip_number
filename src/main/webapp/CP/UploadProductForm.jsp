  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
                       ...
                       <form class="form-horizontal" action="BulkInsertProduct"  method="post" name="form" ENCTYPE="multipart/form-data">
                                        ...
                                        <div class="box-footer">
                                        	...
                                        	<a href="CP/BulkDataUpload.csv" class="btn btn-info pull-left" target="_blank">Download Sample File</a>
                                        </div>
