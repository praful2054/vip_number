...
<nav class="navbar navbar-static-top">
  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
	                   <%
						   String subCategoryId = request.getParameter("subcateId");
							String subCategory = request.getParameter("subCateName");
						%>
                       <form class="form-horizontal" action="insertCategories"  method="post" name="form" ENCTYPE="multipart/form-data">
                                    ...
                                    <%
                                     	if(subCategory!=null && !subCategory.isEmpty()){
											...
											List<Category> parentCategoriesList = generfunc.getParentCategoryList();
									%>
                                       <div class="form-group">
                                            <label class="col-sm-2 control-label">Category Name</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="Sub_cate_name" type="text" value="<%=subCategory%>" readonly>
                                            </div>
                                        </div>
                                        <input type="hidden" name="parentCategoryId" value="<%=subCategoryId%>"/>
									<%
										}
									%>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="cate_name" type="text" value="" required="required">
                                            </div>
                                        </div>
										 ...
										 <div class="form-group">
                                           ...
                                           <div class="col-sm-10">
                                                <textarea id="editor1" name="cate_descript" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Add Category Details</button>
                                        </div>
...
<!-- CK Editor -->
<script src="./CP/js/ckeditor/ckeditor.js"></script>
<script>
  $(function () {
