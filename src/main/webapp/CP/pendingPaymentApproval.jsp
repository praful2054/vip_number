            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                                        ...
                                        List<OrderPaymentDetail> customerLoginDetails = dbAction.getDataList(QueryConstants.ORDER_TRANSACTION_Pending_PAYMENT_DATA_QUERY,OrderPaymentDetail.class);

                                        	for(OrderPaymentDetail details : customerLoginDetails) {
                                        ...
                                        <td class="center"><%=sr%></td>
                                            ...
                                            <td class="center">NW000<%=details.getOrderid() %></td>

                                            <td class="center"><%=details.getTracking_id() %></td>

                                            <td class="center"><%=details.getPayment_mode()==null?"":details.getPayment_mode() %></td>

                                            <td class="center"><%=details.getCard_name()==null?"":details.getCard_name() %></td>

                                            <td class="center"><%=details.getAmount() %></td>

											<td><%=outputFormat.format(inputFormat.parse(details.getPayment_date())) %></td>

                                            <td class="center"><%=details.getStatus() %></td>

                                            <td class="center">
                                            		<a class="btn btn-mini btn-success"  href="paymentApproval?payId=<%= details.getId()%>&orderId=<%=details.getOrderid()%>">Approved</a>
												</td>
