	...
	<div class="box box-success">
	 ...
	 try{
		 ClassPathXmlApplicationContext context = (ClassPathXmlApplicationContext) application.getAttribute("context");
			...
			String failedUpload= "", errorMSG= "";
			String Number[] = request.getParameter("prodName").split("\\r?\\n");
			String prdtName = "";
			int pr = Integer.parseInt(request.getParameter("rateRuppes"));

			for(int i=0;i<Number.length;i++){
				 prdtName = Number[i].replaceAll("\\<[^>]*>","");
			...
			String smsApproval = request.getParameter("approvalSMS");
			...
			product.setProductName(Number[i]);
			...
			dbAction.executeDML(query);
					...
					e.getMessage();
					failedUpload = failedUpload +" , "+prdtName;
					//out.print("Failed Numbers "+prdtName);
