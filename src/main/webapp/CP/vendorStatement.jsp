                ...
                <td colspan="6">
                    <table>
                        ...
                        <tr>
                           ...
                           Shop No 23, Old idea point, <br>Main market, Police station Road,<br>
Anupgarh Distt. <br>Sri ganganagar Rajasthan 335701
							www.vipnumberstore.in<br>
     ...
     %>
            <tr class="item">
                ...
                <td width="20%"><%=outputFormat.format(inputFormat.parse(res.getString("orderPlacedDate"))) %></td>
            ...
            <%} 
                            		...
                            		if(startDate !=null && endDate!=null && !startDate.equals("null") && !endDate.equals("null")){
									   ...
									   int totalcredit=0;
									   if(startDate !=null && endDate!=null && !startDate.equals("null") && !endDate.equals("null")){
		                               		 res = stmt1.executeQuery("select sum(po.rateblack)  from OrderPurchaseDetails op, OrderTransaction ot, ProductDetails pd, ProductOtherDetails po where pd.vendor_id='"+VendorId+"' and op.product_id = pd.product_id and ot.orderId = op.orderId  and pd.product_id = po.product_id and ot.paymentStatus='Y' and ot.orderStatus='Order Confirmed' and DATE(ot.orderPlacedDate) between '"+startDate+"' and '"+endDate+"' ");
		                               		}else{
		                               			 res = stmt1.executeQuery("select sum(po.rateblack) from OrderPurchaseDetails op, OrderTransaction ot, ProductDetails pd, ProductOtherDetails po where pd.vendor_id='"+VendorId+"' and op.product_id = pd.product_id and ot.orderId = op.orderId  and pd.product_id = po.product_id and ot.paymentStatus='Y' and ot.orderStatus='Order Confirmed'");
		                               		}
