  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 ...
	 try{
		...
		PreparedStatement prepare1=con.prepareStatement("select loginId from employee where loginId='"+request.getParameter("loginId")+"'");
		ResultSet rs = prepare1.executeQuery();
		if(rs.next()){
			%>
			<div class="alert alert-error">
         <button type="button" class="close" data-dismiss="alert">×</button>
         <strong>Employee Login Alredy Exits....</strong>
        </div>
			
			<%
		}else{
			prepare=con.prepareStatement("insert into employee values(0, ?, ?, ?, ?, ?, ?, ?, ?, ? ,curDate())");
			prepare.setString(1,request.getParameter("loginId"));
			prepare.setString(2,request.getParameter("password"));
			prepare.setString(3,request.getParameter("firstname"));
			prepare.setString(4,request.getParameter("lastname"));
			prepare.setString(5,"");
			prepare.setString(6,request.getParameter("contactno1"));
			prepare.setString(7,request.getParameter("contactno2"));
			prepare.setString(8,request.getParameter("profile"));
			prepare.setString(9,"Y");
