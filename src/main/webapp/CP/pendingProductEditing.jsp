...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
			...
			List<Product> productList = dbAction.getDataList(QueryConstants.PRODUCT_Pending_EDITING_PANEL_QUERY, Product.class);
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 <th>SR</th>
					...
					<th>Days</th>
					<th>Rate</th>
					<% if(profile.equalsIgnoreCase("Lead") || profile.equalsIgnoreCase("SEO")){%>
					<th>Vendor</th>
					<%} %>
					<th>Updated Date</th>
					<th>Status</th>			
                ...
                String updatedby="",actdate="",Full_Name="";
                int sr=0;
                for(Product details : productList){
					...
					updatedby = details.getUpdated_by()==null?"":details.getCreated_by();
					 
					 rs =  stmt.executeQuery("select firstname, lastname from employee where loginId='"+updatedby+"'");
                   	if(rs.next()){
