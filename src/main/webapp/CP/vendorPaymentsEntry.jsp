  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Vendor Payment Form</li>
      </ol>
    </section>
	...
	<div class="box box-success">
	 <div class="box-body">
                       ...
                       <form class="form-horizontal" action="insertVendorPayments"  method="post" name="form" ENCTYPE="multipart/form-data">
                                	...
                                	ResultSet res = stmt.executeQuery("select * from vendorDetails where firstname is not null and status='"+type+"'");
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select style="width:250px" id="selectError3" name="orderId" required="required">
                                                <option value="">------Select--------</option>	
                                                <% while(res.next()) { %>
                                                 <option value="<%=res.getString("id")%>"><%=res.getString("firstname")%></option>	
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="remarks" type="text" value="" required="required">
                                            </div>
                                        </div>
