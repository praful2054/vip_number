	...
	<div class="box box-success">
	 <div class="box-body">
	  ...
	  String nickName="",bankName="",accountName="",accountNumber="",branchLocation="",ifscCode="";
               		...
               		ResultSet res = stmt.executeQuery("select * from vendorDetails where id="+id);
                       if(res.next()) {
                       ...
                       <form class="form-horizontal" action="updateVendor"  method="post" name="form" ENCTYPE="multipart/form-data">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="isregister" required="required">
                                                 <option value="">-----Select-----</option>
                                                    <option value="Yes" <%if(isRegistered.equalsIgnoreCase("Yes")){%>selected<%} %>>Yes</option>	
                                                    <option value="No" <%if(isRegistered.equalsIgnoreCase("No")){%>selected<%} %>>No</option>	
                                                </select>
                                            </div>
                                        </div>

<%
											if(docs != null && !docs.equalsIgnoreCase("null") && !docs.equalsIgnoreCase("")) {
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                               <a href="./VendorDocs/<%=docs %>" target="_blank"><img src="./VendorDocs/<%=docs %>" height="200" width="200"></a>
                                            </div>
                                        </div>
									...
									<%
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Update Vendor Details</button>
                                        </div>
