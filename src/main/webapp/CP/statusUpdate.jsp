            ...
            %>
			 <div class="content-wrapper">
						...
						<div class="box box-success">
						 <div class="box-body">
                            <form class="form-horizontal" action="updateStatus"  method="post" name="form" >
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="status"  required>
                                                 ...
                                                 <option value="Sold" <%if(status.equalsIgnoreCase("Sold")){%>selected<%} %>>Sold</option>
												 <option value="Sold By Vendor" <%if(status.equalsIgnoreCase("Sold By Vendor")){%>selected<%} %>>Sold By Vendor</option>
                                                  <option value="Hold" <%if(status.equalsIgnoreCase("Hold")){%>selected<%} %>>Hold</option>
                                                 <option value="Not Available" <%if(status.equalsIgnoreCase("Not Available")){%>selected<%} %>>Not Available</option>
                                                </select>
                                            </div>
                                        </div>
