	...
	<div class="box box-success">
	 ...
	 try{
		...
		Connection con=new DBConnection().getCon();
			...
			prepare=con.prepareStatement("update employee set loginId=?,password=?,firstname=?,lastname=?,contactno1=?,contactno2=?,profile=?, updatedDate=Now() where id=?");
			...
			prepare.setString(5,request.getParameter("contactno1"));
			prepare.setString(6,request.getParameter("contactno2"));
			prepare.setString(7,request.getParameter("profile"));
			prepare.setString(8,request.getParameter("id"));
			
			
			int row=prepare.executeUpdate();
	 %>
		 <div class="callout callout-success">
                <h4>Employee Update Sucessfully !</h4>
              </div>
		 <%}
