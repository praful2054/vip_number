  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 ...
	 try{
			...
			Number customerId =  Integer.parseInt(request.getParameter("cust_id"));
			...
			//Inserting Customer Details
				...
				obj.setSql(QueryConstants.CUSTOMER_BILLING_ADDRESS_UPDATE_QUERY);
				obj.setAction(GeneralConstants.UPDATE);
				dbAction.executeDML(obj);
				
				obj = new CustomerAddressQueryParameter(shippingAddress);
				obj.setSql(QueryConstants.CUSTOMER_SHIPPING_ADDRESS_UPDATE_QUERY);
				obj.setAction(GeneralConstants.UPDATE);
				dbAction.executeDML(obj);
