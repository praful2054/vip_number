  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Coupouns Form</li>
      </ol>
    </section>
	...
	<div class="box box-success">
	 <div class="box-body">
                       ...
                       <form class="form-horizontal" action="insertCoupoun"  method="post" name="form">
                       
                                     <div class="form-group">
                                            <label class="col-sm-2 control-label">Coupoun Name</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="coupounName" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Coupoun Type</label>
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="coupounType">
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-2 control-label">Coupoun Value</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="CoupounValue" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="user">
										 ...
										 <div class="form-group">
                                           ...
                                           <div class="col-sm-10">
                                                <textarea id="editor1" name="userid" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Add Coupoun Details</button>
                                        </div>
