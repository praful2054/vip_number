  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 ...
	 %>
                       ...
                       <form class="form-horizontal" action="updateCustomer"  method="post" name="form">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="firstname" type="text" value="<%=detail.getFirstName() %>" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Email</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="email" type="text" value="<%=lDetail.getEmailid() %>" required="required">
                                            </div>
                                        </div>
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="telephone" type="text" value="<%=detail.getContactNo1() %>" required="required">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="companyName" type="text" value="<%=detail.getCompanyName() %>" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">GSTIN NO</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="gstin" type="text" value="<%=detail.getGstinNO() %>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="address_1" type="text" value="<%=detail.getAddress()%>" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="postcode" type="text" value="<%=detail.getPincode() %>" required="required">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="state" type="text" value="<%=detail.getState()%>" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Update Customer Details</button>
                                        </div>
