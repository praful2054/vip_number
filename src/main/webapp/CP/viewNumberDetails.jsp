  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Number Details</li>
      </ol>
    </section>
	 ...
	 <div class="box-body">
	                   <%
						  ...
						  number = number.replaceAll("&nbsp;","");
							...
							ProductOtherDetail productOtherDetail = dbAction.getSingleData(QueryConstants.PRODUCT_RATE_SINGLE_DATA_QUERY, ProductOtherDetail.class, product.getProduct_id());
							GeneralDAO gdao = new  GeneralDAO();
							String vendorName=gdao.getVendorDetails(product.getVendor_id());
						%>
                       <form class="form-horizontal" action="UpdateProductDetails"  method="post" name="form">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" name="sub_cate_id" readonly="readonly">
                                                    <%
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="rateRuppes" readonly="readonly" type="text" value="<%=product.getNumber() %>" required="required">
                                            	
                                            </div>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label class="col-sm-2 control-label">Sum Total</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="rateRuppes" readonly="readonly" type="text" value="<%=product.getLiters() %>=<%=product.getTrap() %>" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="rateRuppes" readonly="readonly" type="text" value="<%=product.getProductBrand()==null?"":product.getProductBrand()%>" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="rateRuppes" readonly="readonly" type="text" value="<%=product.getPacking()==null?"":product.getPacking()%>" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="rateRuppes" readonly="readonly" type="text" value="<%=product.getVegProduct() ==null?"":product.getVegProduct()%>" required="required">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="rateRuppes" readonly="readonly" type="text" value="<%=productOtherDetail.getRateInRupee() %>" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" readonly="readonly" name="rateBlack" type="text" value="<%=vendorName %>" required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" readonly="readonly" name="rateBlack" type="text" value="<%=productOtherDetail.getRateblack() %>" required="required">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="buyerName" readonly="readonly" type="text" value="<%=product.getBuyerName() %>" >
                                            </div>
                                        </div>
                                        <%} %>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="discount" readonly="readonly" type="text" value="<%=productOtherDetail.getDiscount()%>">
                                            </div>
                                        </div>
