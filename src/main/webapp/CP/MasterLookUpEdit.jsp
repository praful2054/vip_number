...
<nav class="navbar navbar-static-top">
  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
                                <form class="form-horizontal" action="updateMaster"  method="post" name="form">
                                   
                                    <%
                                  //type= state_list,district_list,taluka_list
                            		
                            		String id = request.getParameter("id");
                            		String type = request.getParameter("type");
                            		int iCountry = (request.getParameter("country") == null || request.getParameter("country").equals("null")) ? 0 : Integer.parseInt(request.getParameter("country"));
                            		...
                            		List<MasterLookUp> countryList = null;
                            		if(type != null && !type.equalsIgnoreCase("country_list")){
                            			countryList = generalFunction.getCountryList();
									...
									<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="country">
                                                    <%
														for(MasterLookUp country : countryList){
													%>
														<option value="<%=country.getLookupCode() %>"<%if(country.getLookupCode() == iCountry){ %>selected="selected"<%} %>><%=country.getLookupMeaning() %></option>
													<%} %>
                                                </select>
                                            </div>
                                        </div>
									...
									%>
									<div class="form-group">
                                            <label class="col-sm-2 control-label"><%=type.replaceAll("_list","") %></label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="type" type="text" value="<%=detail %>" >
                                            </div>
                                        </div>
                                        
                                        
                                         <%if("state_list".equals(type)) {
                                        	 String shipping = request.getParameter("shipping");
                                         %>
                                         <div class="form-group">
                                            <label class="col-sm-2 control-label">Pincode</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="shippingCharge" type="text" value="<%=shipping %>" >
                                            </div>
                                        </div>
								...
								<div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Update Master Details</button>
                                        </div>
