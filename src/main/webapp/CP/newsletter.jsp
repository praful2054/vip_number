            ...
            <div class="box-body">
              <table id="example1" class="table table-striped table-hover dt-responsive" width="100%">
                                    ...
                                    <tbody>
                                		...
                                		ResultSet res = stmt.executeQuery("select * from newsletter");
                                        ...
                                        <tr>
                                            ...
                                            <td class="center"><%=res.getString("email") %></td>
                                            
                                             <td class="center"><%=res.getString("status") %></td>
                                             
                                              <td class="center"><%=res.getString("updatedDate") %></td>

                                            <td class="center">

												
												<a class="glyphicon glyphicon-trash" href="delete?id=<%=res.getString("id") %>&type=Subscription"></a>
