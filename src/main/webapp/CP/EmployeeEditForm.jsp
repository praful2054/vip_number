...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
	                   <%
	                   String loginId="",password="",Fname="",LName="",contactNo="",Email="",role="";
                       ...
                       if(res.next()) {
                    	   ...
                    	   Email = res.getString("contactno2");
                    	   role = res.getString("profile");
                       }
	                   %>
                       <form class="form-horizontal" action="updateEmployee"  method="post" name="form">
                       <input type="hidden" name="id" value="<%=id%>">
                                     <div class="form-group">
                                            <label class="col-sm-2 control-label">Login Id</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="loginId" type="text" value="<%=loginId %>" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="firstname" type="text" value="<%=Fname %>" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Last Name</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="lastname" type="text" value="<%=LName %>" required="required">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-2 control-label">Contact Number</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="contactno1" type="text" value="<%=contactNo %>" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Email Address</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="contactno2" type="text" value="<%=Email %>" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="profile">
                                                    <option value="Admin" <%if(role.equalsIgnoreCase("Admin")){%>selected<%} %>>Admin</option>	
                                                    <option value="Lead" <%if(role.equalsIgnoreCase("Lead")){%>selected<%} %>>Lead</option>	
                                                    <option value="Sales" <%if(role.equalsIgnoreCase("Sales")){%>selected<%} %>>Sales</option>
                                                    <option value="Data Entry" <%if(role.equalsIgnoreCase("Data Entry")){%>selected<%} %>>Data Entry</option>
                                                    <option value="SEO" <%if(role.equalsIgnoreCase("SEO")){%>selected<%} %>>SEO</option>
                                                </select>
                                            </div>
                                        </div>

                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Update Employee Details</button>
                                        </div>
