  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Coupoun Details</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <%
                                		...
                                		ResultSet res = stmt.executeQuery("select * from Coupoun");
                                        while(res.next()) {
										%>
                                        <tr>
                                        <td class="center"><%=res.getString("coupoun_id") %></td>
                                           <td class="center"><%=res.getString("coupoun_type") %></td>
                                            <td class="center"><%=res.getString("coupoun_code") %></td>
                                            <td class="center"><%=res.getString("user_for") %></td>
											<td class="center"><%=res.getString("value") %></td>
                                            <td class="center">
													<a class="glyphicon glyphicon-trash" href="delete?id=<%=res.getString("coupoun_id") %>&type=coupoun"></a>
												</td>
