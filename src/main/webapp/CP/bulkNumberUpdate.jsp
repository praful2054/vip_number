	...
	<div class="box box-success">
	 <div class="box-body">
	                   <%
						...
						%>
                       <form class="form-horizontal" action="updateBulkNumbers"  method="post" name="form">
                                        
                                        
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Action</label>
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="actionF" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <textarea id="editor1" name="prodName" rows="10" cols="80" required="required"></textarea>
                                            </div>
                                        </div>                                        
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Update Number Status</button>
                                        </div>
