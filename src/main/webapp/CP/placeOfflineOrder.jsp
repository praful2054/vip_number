  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
                       ...
                       <form class="form-horizontal" action="insertofflineOrder"  method="post" name="form">
                              <input type="hidden" name="custId" value="<%=request.getParameter("custId")%>">
                              <input type="hidden" name="email" value="<%=request.getParameter("email")%>">
                              
                       
                       					<div class="form-group">
                                            <label class="col-sm-2 control-label">Customer Login ID</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="custEmail" type="text" value="<%=request.getParameter("email")%>" readonly="readonly">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Numbers</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="numbers" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="gst" required="required">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Email To Customer</label>
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="emailFlag" required="required">
                                                <option value="">------Select--------</option>	
                                                    <option value="Yes">Yes</option>	
                                                    <option value="No">NO</option>
                                                </select>
