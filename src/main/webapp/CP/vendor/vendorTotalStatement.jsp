...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form name="search" id="search" method="post" action="vendorTotalStatement">
<table id="example1" class="table table-bordered table-striped">
                ...
                <%
                                		...
                                		ResultSet res = stmt.executeQuery("select * from vendorDetails where firstname is not null and status='Y' and id='"+eid+"' order by firstname asc");
                                        while(res.next()) {
                                        ...
                                        <tr>
											...
											<td class="center"><a class="glyphicon glyphicon-file" href="#?vendorId=<%=res.getString("id")%>&startDate=<%=startDate%>&endDate=<%=endDate%>" target="_blank"></a></td>
