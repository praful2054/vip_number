  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Call Date Details</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <%
                                		...
                                		ResultSet res = stmt.executeQuery("select * from ProductDetails where vendor_id ='"+id+"' and lastcall!='' and nextcall!='' order by nextcall");
                                        int sr=0;
                                        String rechargeDate="", nextCallDate="";
                                		...
                                		while(res.next()) {
                                			sr++;
                                			rechargeDate = res.getString("lastcall");
                                			recharge_Date = formatter.parse(rechargeDate);
                                			
                                			nextCallDate = res.getString("nextcall");;
                                			
                                			nextRecharge =  formatter.parse(nextCallDate);
