	...
	<div class="box box-success">
	 <div class="box-body">
	                   <%
						...
						%>
                       <form class="form-horizontal" action="vendorInsertProductDetail"  method="post" name="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="prodName" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="veg" onchange="hideshow();" required>
                                                <option value="">---Select-----</option>
                                        ...
                                        <input type="hidden" name="prodType" value="None">
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Add Product Details</button>
                                        </div>
