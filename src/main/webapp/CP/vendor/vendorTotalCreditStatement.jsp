            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                                		...
                                		// res = stmt.executeQuery("select * from  vendorAccounts va  where va.vendorId='"+VendorId+"' and MONTH(orderPayDate)=MONTH(CURRENT_DATE) order by orderPayDate desc");
                                        while(res.next()) {
                                        	sr++;
                                        	rateblack=0;
                                            ...
                                            if(PaymentStatus.equals("Cancelled")){
        										%>
        										<tr class="strikeout" style="color:red">
        										<%}else{ %>
        										<tr>
                                                <%} %>
                                            <td class="center"><%=sr %></td>
                                            <td class="center">NW000<%=res.getString("orderId") %> </td>
                                            <td class="center"><%=outputFormat.format(inputFormat.parse(res.getString("orderPayDate"))) %> </td>
