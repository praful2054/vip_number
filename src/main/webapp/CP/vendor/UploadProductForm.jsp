  ...
  <div class="content-wrapper">
	...
	<div class="box box-success">
	 <div class="box-body">
                       ...
                       <form class="form-horizontal" action="vendorBulkInsertProduct"  method="post" name="form" ENCTYPE="multipart/form-data">
                                   

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Product Upload</label>
                                            <div class="col-sm-6">
                                                <input type="file" class="form-control" name="product_upload">
                                                </div>
                                            
                                        </div>

                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Upload Product Details</button>
                                        	<a href="CP/vendor/BulkDataUpload.csv" class="btn btn-info pull-left" target="_blank">Download Sample File</a>
                                        </div>
