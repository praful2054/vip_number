...
function checkMobileNumber(){
            ...
            var vProdCode = document.form.cmobile.value;
            ...
            req.open("POST", "validateMobileNo", true);

            req.onreadystatechange = callbackRelevantProductCode;

            req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            req.send("vMobileNo=" + encodeURIComponent(vProdCode));
        }
        function callbackRelevantProductCode(){
            ...
            if (req.readyState == 4) {
                if (req.status == 200) {
                    ...
                    var vreldet = document.getElementById("divmobileNumberCheck");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Offline Enquiry Form</li>
      </ol>
    </section>
	...
	<div class="box box-success">
	 <div class="box-body">
                       <form class="form-horizontal" action="InsertofflineEnquires"  method="post" name="form">

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Required Number</label>
                                            <div class="col-sm-6">
                                            <input class="form-control" id="focusedInput" name="requirement" type="text" value="" required="required">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="budget" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="etype"  required>
                                                <option value="">---Select-----</option>
                                                 <option value="Vanity Number">Vanity Number</option>
                                                 <option value="Numerology Number">Numerology Number</option>
                                                 <option value="Birthday Date">Birthday Date</option>
                                                  <option value="Lucky Number">Lucky Number</option>
                                                  <option value="Area Pincode Number">Area Pincode Number</option>
                                                 <option value="Car Number">Car Number</option>
                                                  <option value="Similar Number">Similar Number</option>
                                                  <option value="Phone Word">Phone Word</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="cname" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="cmobile"  type="text" value=""  required="required">
                                           		<div id="divmobileNumberCheck"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="cemail" type="text" value=""  required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="focusedInput" name="ccity" type="text" value="" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Enquiry Source</label>
                                            <div class="col-sm-10">
                                                <select style="width:250px" id="selectError3" name="esource"  required>
                                                <option value="">---Select-----</option>
                                                
                                                 <option value="Online Chat">Online Chat</option>
                                                 <option value="Offline Chat">Offline Chat</option>
                                                  <option value="Whatsapp 007">Whatsapp 007</option>
                                                  <option value="IVR Call">IVR Call</option>
                                                 <option value="Facebook">Facebook</option>
                                                  <option value="Insta">Insta</option>
                                                  <option value="Exsiting Customer">Exsiting Customer</option>
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-info pull-right">Add Enquiry Details</button>
                                        </div>
