...
<div id="site-container" class="site-fullscreen site-sticky">
	...
	<!-- Services -->
	<section id="services" class="box-white mobileovhi">
		<div class="wrapper padding-all overflowhi">
        
        
         <div class="text-center">
        <h2 class="headingpage" style="line-height:30px;">Get Your <br>
<span style="font-size:32px;">VIP NUMBERS</span>
        </h2>
        </div>
        ...
        <%
        	...
        	<div class="numberbox">
                ...
                <p> Sum total: <%=product.getLiters() %>=<b><%=product.getTrap() %> </p>
        ...
        <input type="hidden" name="vProductId" id="vProductId" value="<%= product.getProduct_id()%>">
         ...
         <div class="text-center">
        	<a href="VIPNumbers" class="btn btn-default gradiyant margin-top-10 "><i class="fa fa-pencil-square-o"></i> MORE NUMBER</a>
            </div>
...
<br>
 ...
 <br>
    ...
    <section id="services" class="box-white">
        ...
        <div class="text-center">
        <h2 class="headingpage" style="line-height:30px;">Get Your <br>
<span style="font-size:32px;">Dream Numbers</span>
        </h2>
        </div>
        ...
        <%
         ...
         <input type="hidden" name="vProductId" id="vProductId" value="<%= product.getProduct_id()%>">
													<input type="hidden" name="vProductName" id="vProductName" value="<%= product.getProductName()%>">
													<input type="hidden" name="vRateRuppes" id="vRateRuppes" value="<%= product.getRateInRupee()%>">
													<input type="hidden" name="vRateDollar" id="vRateDollar" value="<%= product.getRateInDollar()%>">
													<input type="hidden" name="vImgLoc" id="vImgLoc" value="<%= product.getImg_loc()%>">
													<input type="hidden" name="vDiscount" id="vDiscount" value="<%= product.getDiscount()%>">
    ...
    <section id="customers" class="box-grey padding-all">
		<div class="wrapper">
			<div class="row margin-none col-half">
             <div class="text-center">
              <h2 class="headingpage" style="line-height:30px;">CUSTOMIZE <br>
<span style="font-size:32px;">YOUR NUMBERS</span>
        </h2>
