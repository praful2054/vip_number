...
else if(session.getAttribute("custId")==null || session.getAttribute("custBillingDetails")==null){
	   response.sendRedirect("signin.jsp?redirectTo=checkout");
}else{
					...
					<div class="col-md-12">
						<div class="cart">
							<div class="section-title mb-30 text-center text-uppercase">
								<h2 class="headingpage">Checkout </h2>
							</div>
						...
						<div class="cart_description">
								<div class="table-content table-responsive mb-50 boxshadow">
								<form name="payment" id="paymentForm" method="post" action="paymentconfirm">
						<table class="">
										<thead>
											<tr class="tabletop">
												<th width="7%" class="product-remove gradiyant"></th>
												<th width="43%" class="product-name gradiyant">Payment</th>
										...
										<tbody>
											...
											<tr class="cart-item">
												<td class="product-remove">
													<input type="radio" name="pmode" class="pmode" value="Paytm"  checked style="margin-right: 10px; border: 1px solid rgb(204, 204, 204);">
												</td>
												<td class="product-name">
											   <b> Paytm, Google Pay, UPI, PhonePe</b>
													<div>
														<img src="assets/img/Paytm_gatway.PNG" style="width: 266px;">
													</div>
											    </td>
											...
											<tr class="cart-item">
												<td class="product-remove">
													<input type="radio" name="pmode" class="pmode" value="RazorPay"   style="margin-right: 10px; border: 1px solid rgb(204, 204, 204);">
												</td>
												<td class="product-name">
											    <b> Debit Card, Credit Card, Net Banking, Mobikwik, PayZapp, Airtel Money, Freecharge, JioMoney </b>
													<div style=""><img src="assets/img/Razor_gatway.PNG" style="width: 266px;"></div>
												</td>
											...
											<tr>
												<td colspan="5" class="actions text-right clear">
                                                          ...
                                                          <a  onclick="document.getElementById('paymentForm').submit();" class="btn btn-default leave-new margin-top-10 gradiyant"> Proceed To Pay 	</a>
