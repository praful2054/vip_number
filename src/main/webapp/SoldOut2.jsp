...
<div id="site-container" class="site-fullscreen site-sticky">
			...
			<div class="wrapper clearfix">
                ...
                <div class="header-search">
					...
					<a href="cart"> <div class="carticon"> <i class="fa fa-shopping-cart"></i> </div> </a>
                        ...
                        <a href="cart"> <div class="singin venlogin"> Vendor login </div> </a>
                </div>
	...
	<section id="services" class="box-grey mobileovhi">
        ...
        <div class="overflowhi">
        	...
        	<div class="numberbox numberbox4">
            
            	<div class="price cod">
                <div class="price1left" style="width:50%">Cash on Delivery</div>
                
                
                <div class="price2right" style="width:50%"> &#8377; 2000</div>
       	    ...
       	    <img src="assets/img/soldoutfile.png" width="76" height="64" style="float:right; margin-right:10px; margin-top:-25px;"> </div>
		...
		<div class="wrapper">
			...
			<div class="footer-middle">
				<div class="row margin-none">
					<div class="col-md-8 col-sm-12 padding-none menubarbo">
			...
			<div class="footer-bottom">
				<div class="row margin-none">
					<div class="col-md-12 col-sm-12 padding-none">
						<p class="text-medium text-small">&copy; Vip Number Store. All Rights Reserved.</p>
					</div>
				</div>
			</div>
			<!-- Footer Bottom End -->
