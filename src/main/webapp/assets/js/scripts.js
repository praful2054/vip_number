...
$(document).ready(function (e) {
    ...
    function o() {
        var t = e(".header-menu").clone(), a = e(".header-search").clone(),
        ...
        e(t).appendTo(".site-nav"), e(a).appendTo(".site-nav"), e(i).appendTo(".site-nav"), e(o).appendTo(".site-nav"), e(".header-nav").on("click", function (t) {
            t.preventDefault();
            var a = e(".site-nav");
            e(a).is(":visible") ? (e(this).removeClass("active"), e(a).animate({left: "-250px"}, "slow", function () {
                e(a).hide()
            })) : (e("body,html").animate({scrollTop: 0}, 800), e(this).addClass("active"), e(a).show(), e(a).animate({left: "0px"}, "slow"))
    ...
    f.imagesLoaded(function () {
        f.masonry({itemSelector: ".masonry-item", columnWidth: ".grid-sizer", isAnimated: !0})
    }), e(".video-full").fitVids(), e("a[data-rel^='prettyPhoto']").prettyPhoto({social_tools: !1}), e(".countTo").countTo(), e(".site-back-top").click(function (t) {
        return t.preventDefault(), e("body,html").animate({scrollTop: 0}, 800), !1
    }), e(".leave-new").click(function (t) {
        t.preventDefault();
        var a = e(".comment-form").offset();
        return e("html, body").animate({scrollTop: a.top}, 800), !1
        ...
        map: {
            ...
            latLng: [51.5209564, .157134], callback: function () {
        ...
        }, marker: {latLng: [51.5209564, .157134]}
    }), e.stellar({horizontalScrolling: !1}), e(window).scroll(function () {
        a(), t()
    ...
    if ($(window).width() <= 990) {
        ...
        $(document).ready(function () {
            $(".filterop").click(function () {
                $(".filteroption").toggleClass("displaynonefilter");
            });

        });

        $('.filterop').click(function (e) {
...
$(document).ready(function () {
    ...
    $('.iconmobilebottom').hide();

    if ($(window).width() <= 990) {
        $('.chatmob').click(function (e) {

            e.preventDefault(); // stops link from making page jump to the top
            e.stopPropagation(); // when you click the button, it stops the page from seeing it as clicking the body too
            $('.iconmobilebottom').toggle();

        });


        $('.piconmobilebottom').click(function (e) {
