...
<br>
                            ...
                            String address_1 = request.getParameter("address_1");
                            	...
                            	try{
                            		...
                            		//String Message = "Dear {#var#}, # {#var#} is OTP to create your VipNumberStore account. OTP is valid for 5 min. Do not share Your OTP with anyone."; 
                            		String Message = "Dear "+firstname+", Thank you For Registration. "+otp+" is The OTP For Request. Regards Vipnumberstore.in";		
 									String sendUrl = "https://alerts.kaleyra.com/api/v4/?method=sms&api_key=A95f6ac715c8eb5e4eac8a88b231a4d8a&to="+telephone.trim()+"&sender=VIPNUM&message="+Message+"";	
                            ...
                            %>   
                             ...
                             <form action="registerCustomerOTP.jsp" method="post">
							<div class="row">
								<div class="col-md-12 col-sm-12 margin-bottom-10">
									<img src="assets/img/otp_verify.jpg" class="img-responsive preLoad loaded" alt="" title="" style="width: 18%;margin-top: -30px;margin-bottom: 10px;">
