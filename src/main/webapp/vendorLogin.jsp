			...
			<div class="wrapper padding-all">
                ...
                <div class="col-md-1 col-sm-12"> </div>
					...
					<div class="col-md-5 col-sm-12 boxshadow padding-all-20">
						<div class="data-form">
							<form action="vendorLoginValidate" method="post">
							<div class="row">
							<p><%=request.getParameter("status")==null?"":request.getParameter("status")%></p>
								<div class="col-md-12 col-sm-12 margin-bottom-10">
									<h2 class="heading_for_subtitle">Vendor Login</h2>
									<!-- <label>E-Mail</label> -->
									<div class="form-field">
										<i class="fa fa-envelope-o"></i>
										<input type="text" name="loginId" placeholder="Enter your Registered Mobile No" required>
									</div>
								</div>
								<div class="col-md-12 col-sm-12 margin-bottom-10">
									<!-- <label>Name</label> -->
